...
rice_map <- read_tsv("~/Google Drive/RMB/PNASData/FieldExp/field_metadata.txt") %>% 
...
total_map <- as_tibble(bind_rows(maize_map, grape_map, cannabis_map, rice_map, boechera_map, domestication_map, rice_knight))
...
wExp %>% 
  ungroup() %>% 
  saveRDS("~/RMB/SoilDomestication/Data/wExp.rds")
```
